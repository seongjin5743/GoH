...
def faceTrain():
    ...
    global cnt
    cnt = 0
    return "<script>alert('얼굴 등록이 완료되었습니다');location.href='http://223.194.136.183:8080/';</script>"
...
def otpCheck():
    ...
    if check_correct == 2:
        return "<script>alert('시간이 초과되었습니다');location.href='http://223.194.139.86:8080/';</script>"
        ...
        while True:
            if count < 10:
                ...
                arduino.write(b'0')
                time.sleep(1)
                return "<script>alert('인증이 완료되었습니다');location.href='http://223.194.139.86:8080/';</script>"

        return "<script>alert('인증이 완료되었습니다');location.href='http://223.194.139.86:8080/';</script>"
    else:
        return "<script>alert('잘못된 입력입니다');location.href='http://223.194.139.86:8080/';</script>"
